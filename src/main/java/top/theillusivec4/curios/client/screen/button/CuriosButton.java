...
import top.theillusivec4.curios.mixin.core.AccessorAbstractContainerScreen;
import top.theillusivec4.curios.mixin.core.AccessorInventoryScreen;
...
public class CuriosButton extends ImageButton {
          ...
          (button) -> {
            ...
            if (mc.player != null) {
              ...
              if (parentGui instanceof CuriosScreen curiosScreen) {
                ...
                AccessorInventoryScreen accessInv = (AccessorInventoryScreen) inventoryScreen;
                accessInv.setXMouse(curiosScreen.oldMouseX);
                accessInv.setYMouse(curiosScreen.oldMouseY);
                mc.player.inventoryMenu.setCarried(stack);
                top.theillusivec4.curios.platform.fabric.CuriosFabricNetworking.sendToServer(new CPacketOpenVanilla(stack));
              } else {
                ...
                top.theillusivec4.curios.platform.fabric.CuriosFabricNetworking.sendToServer(new CPacketOpenCurios(stack));
              }
            }
          });
  ...
  public void renderContents(@Nonnull GuiGraphics guiGraphics, int mouseX, int mouseY,
    ...
    AccessorAbstractContainerScreen access = (AccessorAbstractContainerScreen) parentGui;
    this.setX(access.getLeftPos() + offsets.getA() + 2);
    int yOffset = parentGui instanceof CreativeModeInventoryScreen ? 70 : 85;
    this.setY(access.getTopPos() + offsets.getB() + yOffset);
