...
public final class CuriosSlotTypes {
  ...
  public static ISlotType getSlotType(String id) {
    return getSlotType(id, FabricLoader.getInstance().getEnvironmentType() == EnvType.CLIENT);
  }
  ...
  public static Map<String, ISlotType> getSlotTypes() {
    return getSlotTypes(FabricLoader.getInstance().getEnvironmentType() == EnvType.CLIENT);
  }
