      ...
      if (entity instanceof LivingEntity livingEntity) {
        CuriosApi.getCuriosInventory(livingEntity)
            .ifPresent(handler -> {
              ...
              CurioInventory inventory = livingEntity.getAttachedOrCreate(top.theillusivec4.curios.platform.fabric.CuriosFabricRegistry.INVENTORY);
              inventory.setOwner(livingEntity);
