...
public class DynamicStackHandler extends ItemStackHandler implements IDynamicStackHandler {
  ...
  public void clearPreviousStacks() {
    for (int i = 0; i < this.previousStacks.size(); i++) {
      this.previousStacks.set(i, ItemStack.EMPTY);
    }
  }
  ...
  public boolean isItemValid(int slot, @Nonnull ItemStack stack) {
    ...
    top.theillusivec4.curios.platform.fabric.CuriosFabricEvents.post(equipEvent);
  ...
  public @Nonnull ItemStack extractItem(int slot, int amount, boolean simulate) {
    ...
    top.theillusivec4.curios.platform.fabric.CuriosFabricEvents.post(unequipEvent);
