...
import top.theillusivec4.curios.common.handler.SlotItemHandler;
...
public class CurioSlot extends SlotItemHandler {
  ...
  public CurioSlot(
    ...
    if (slotType != null) {
      this.slotIcon = slotType.getIcon();
    }
  ...
  public IDynamicStackHandler getItemHandler() {
    return (IDynamicStackHandler) this.itemHandler;
  }

  @Override
  public Identifier getNoItemIcon() {
    return this.slotIcon != null ? this.slotIcon : super.getNoItemIcon();
  }
